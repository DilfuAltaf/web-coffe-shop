...
<template>
  ...
  >
    ...
    <div v-else class="w-full h-full">
      ...
      >
        ...
        <ul class="flex gap-[56px]">
          ...
          <li><a class="hover:underline" href="#coffe">Coffe</a></li>
          <li><a class="hover:underline" href="#bakery">Bakery</a></li>
          <li><a class="hover:underline" href="#footer">About</a></li>
        </ul>
    ...
    <div
      id="coffe"
      class="bg-[#E1D8C7] flex justify-center flex-col py-[52px] px-[180px] gap-[150px] scroll-mt-20"
    >
    ...
    <div class="text-center width-full py-[90px] bg-[url('/img/bg_bakery.png')]">
  ...
  <!-- Footer (tidak diubah) -->
  <footer id="footer" class="bg-[#000000] text-white px-6 pt-10 scroll-mt-20">
